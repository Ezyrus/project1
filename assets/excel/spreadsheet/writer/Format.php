...
require_once DirExists('lib/excel/spreadsheet/PEAR.php');
/**
...
class Spreadsheet_Excel_Writer_Format extends PEAR
{
    ...
    */
    function Spreadsheet_Excel_Writer_Format($BIFF_version, $index = 0, $properties =  array())
    {
        ...
        $this->_fg_color       = 0x17; /*original :0x40*/
        $this->_bg_color       = 0x17;  /*original :0x41*/
    ...
    */
    function _getColor($name_color = '')
    {
        ...
        if ($name_color == '') {
            // return(0x7FFF); /**this is the original return **/
            return(0x17);
        }
